    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground p-4">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-secondary/50 border border-secondary rounded-lg">
            <h2 className="text-xl font-semibold mb-2">Card 2</h2>
            <p className="text-muted-foreground">This card should have a secondary color background</p>
          </div>
          
          <div className="p-6 bg-gradient-to-br from-primary/20 to-green-500/20 border border-primary/30 rounded-lg">
